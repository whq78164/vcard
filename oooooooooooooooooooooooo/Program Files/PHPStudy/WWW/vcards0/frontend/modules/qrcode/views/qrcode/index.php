...
<?php $this->beginBody() ?>
<h3 class="form-signin-heading text-center"><?=$qrcodereply->tag?></h3>
...
<div class="container">
    ...
    <INPUT type="hidden" id="FWuid" name="FWuid" value="<?=$qrcodereply->uid?>" />
...
<script Charset="UTF-8" type="text/javascript">
     ...
     //                var FWcode = document.getElementById('FWcode').value;
         ...
         var url="<?=Url::to(['qrcode/qrcodequery'],true)?>";
         var data={
             FWcode: FWcode,
             replyid: replyid,
             FWuid: FWuid
