...
<?php $this->beginPage() ?>
    ...
    <head>
        ...
        <img src="<?=$worker['head_img'] ? $worker['head_img'] : 'Uploads/default_face.jpg'?>" width="0" height="0">




        <title><?= Html::encode($worker['name']) ?></title>
    ...
    <div class="loadbox">
        ...
        <div class="game_time">
            ...
            <div class="headImg">
                <section >
                    <div ><img style=" border-radius: 60px;" src="<?=$worker['head_img'] ? $worker['head_img'] : 'Uploads/default_face.jpg'?>" onerror="this.style.display='none'"></div>
                </section>
                ...
                <div class="m-infobox">
                    ...
                    <section class="m-infos">
                        <a href="<?=yii\helpers\Url::to(['user/user'], true)?>" class="m-face-box">
                            <div class="m-face iconfont"><img src="<?=$worker['head_img']?>"></div>
                        </a>
                        <div class="m-infos-cont">
                            ...
                            <div class="m-post ui-elli"><span>
								<?= $worker['department'] ?>
							</span>&nbsp;&nbsp;<span><?= $worker['position'] ?></span></div>
                        </div>
                    </section>
                    <!-- 访客 -->
