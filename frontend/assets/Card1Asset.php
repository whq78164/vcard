...
class Card1Asset extends AssetBundle
{
 ...
 //  public $sourcePath = '@webroot/tbhome/card1';
    ...
    public $css = [
      "tbhome/card1/css/weiba.ui.css",
      "tbhome/card1/css/tpl.css",
       "tbhome/card1/css/custom_tpl_css.css",
      'tbhome/font-awesome/css/font-awesome.min.css',
  //   'https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css',
    ];
    public $js = [
        "tbhome/card1/js/jquery-2.0.3.min.js",
        "tbhome/card1/js/jquery.mobile.events.min.js",
        "tbhome/card1/js/pure.min.js",
        "tbhome/card1/js/weiba.js",
  //      "js/weiba.ui.js",
  //      "/assets/public/js/jDialog/jquery.drag.js",
    //    "/assets/public/js/jDialog/jquery.mask.js",
  //      "/assets/public/js/jDialog/jquery.dialog.js",
        "tbhome/card1/js/weiba.tpl.js",
        "tbhome/card1/js/index.js",
