...
//$classGo1 = isset($_COOKIE['steps'][0]) ? $_COOKIE['steps'][0]:'list-group-item-success';
//$classGo2 = isset($_COOKIE['steps'][1]) ? $_COOKIE['steps'][1]:'list-group-item-success';
?>
...
<div class="col-xs-9">
    ...
    <form class="form-inline" role="form" action="<?=Url::to(['/install/license'])?>" method="post">
        <ul class="pager">
            ...
            <li class="previous">
                <a href="javascript:;" onclick="if(jQuery(':checkbox:checked').length == 1){jQuery('form')[0].submit();
            }else{
