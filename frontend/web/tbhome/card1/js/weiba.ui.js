    ...
    $.getUserInfo = function () {
        ...
        if (wbp) {
            ...
            if (userinfo) {
                ...
                var username = (WBPage.GAME&&WBPage.GAME['name'])?WBPage.GAME['name']:userinfo['name'];
                var usermobile = (WBPage.GAME&&WBPage.GAME['mobile'])?WBPage.GAME['mobile']:userinfo['mobile'];
                var useraddress=(WBPage.GAME&&WBPage.GAME['address'])?WBPage.GAME['address']:'';
...
//                $('.weiba-user-mobile').val(usermobile);
                ...
                $.getJSON(url, data, function (rs) {
                    if (rs['ret'] == 0) {
                        ...
                        var username = (WBPage.GAME&&WBPage.GAME['name'])?WBPage.GAME['name']:rs['data']['name'];
                        var usermobile = (WBPage.GAME&&WBPage.GAME['mobile'])?WBPage.GAME['mobile']:rs['data']['mobile'];
                        var useraddress=(WBPage.GAME&&WBPage.GAME['address'])?WBPage.GAME['address']:'';
                        $('.weiba-user-name').val(username);
                        $('.weiba-user-mobile').val(usermobile);
                        $('.weiba-user-address').val(useraddress);
