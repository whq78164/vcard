...
var is_no_activity = true;
if(window.location.href.indexOf('/activity/')>-1){
    is_no_activity = false;//微现场界面不做统计
}
...
/*if(is_no_activity) {
    (function (document) {
        ...
        (function () {
            var hm = document.createElement("script");
            hm.src = "http://stat.bamastatic.com/log/get_tongji_code";
            var s = document.getElementsByTagName("script")[0];
            s.parentNode.insertBefore(hm, s);
        })();
    })(document);
...
(function($,navigator){
    ...
    if(1){
        var wechat_js_config = '';
        var wechat = '';
        var appId = '';

        //初始化微信JS_API
        var init_wechat_js = function(){
            ...
            wechat.ready(function(){
                ...
                /*出发微信对象准备完成事件*/
                $(document).trigger('wechat_ready',[wechat,wechat_js_config]);
        ...
        $.getJSON('/data/wechatjsapi',{
            ...
            if(result && result['ret']==0 && result['data']){
                ...
                wechat_js_config = result['data'];
                if(wechat && wechat.ready){
                    init_wechat_js();
                }
            }
        });
